            ...
            <ul>
              ...
              <li>
                <span>
                  <span className="animated-layer fade-in-up-animation fadeInUp wow">
                    <span>Email :</span>
                    <span>haseeb@cloudmeshsolutions.com</span>
                  </span>
                </span>
              </li>
              <li>
                <span>
                  <span className="animated-layer fade-in-up-animation fadeInUp wow">
                    <span>Linkedln :</span>
                    <span><a href="https://www.linkedin.com/in/haseebshaikh03/">in/haseebshaikh03</a></span>
                  </span>
                </span>
              </li>
            </ul>
              ...
              <div className="animated-layer fade-in-down-animation fadeInUp wow">
                <div className="experience">
                  ...
                  <p>
                    ...
                    <span>Nov 2022 - Now</span>
                  </p>
                  <p>
                    <i className="fa-regular fa-building" />
                    <span>Cloud Mesh Solutions Pvt Ltd</span>
                  </p>
                </div>
              </div>
            </li>
            ...
            <li>
              <div className="animated-layer fade-in-up-animation fadeInUp wow">
                <div className="experience">
                  ...
                  <p>
                    <i className="fa-regular fa-building" />
                    <span>Ripple Intra Technologies</span>
                  </p>
                </div>
              </div>
            </li>
